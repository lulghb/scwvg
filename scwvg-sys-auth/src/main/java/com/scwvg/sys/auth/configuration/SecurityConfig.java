package com.scwvg.sys.auth.configuration;

import com.scwvg.sys.auth.handler.ScwvgAccessDeniedHandler;
import com.scwvg.sys.auth.handler.ScwvgAuthenticationEntryPoint;
import com.scwvg.sys.auth.service.impl.WvgUserServiceImpl;
...
@MapperScan({"com.scwvg.sys.auth.mapper"}) // mybatis 映射目录
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
				...
				.antMatchers("/admins/**","/auth/**").hasAnyAuthority("ROLE_ADMIN")
				...
				.failureUrl("/login/login-error?secError=true")
